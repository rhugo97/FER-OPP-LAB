...
public class NationalTeamTest {
	...
	public static void main(String[] args) {
		...
		FootballPlayer foreignPlayer = new FootballPlayer("Foreigner", "Portugal", 1, 1, PlayingPosition.DF);
		...
		double expected = (10 * Constants.SEVENTY_PERCENT + 100 * Constants.THIRTY_PERCENT) * 23;
